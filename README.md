...
# 18972-google-analytics-advanced-integration
For more information about this sample see: https://support.brightcove.com/brightcove-player-sample-google-analytics-advanced-integration.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>The JavaScript for the plugin. An example, actual filename could be <strong>advanced-ga.js</strong>.</td>
    </tr>
    <tr>
      <td>plugin/plugin-name.css</td>
      <td>The CSS for the plugin. An example, actual filename could be <strong>advanced-ga.css</strong>.</td>
    </tr>
  </tbody>
</table>
